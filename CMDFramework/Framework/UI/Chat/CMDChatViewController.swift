...
class CMDChatViewController: CMDInitialViewController {
    ...
    private func initHandlers() {
        ...
        NotificationCenter.default.addObserver(forName: Notification.Name.Chat.didChatRate, object: nil, queue: nil) { notification in
    ...
    fileprivate func startChat(withClear clear: Bool = false) {
        ...
        client.startChat(withKey: "TODO KEY")
